...
public class CellProperties {
    ...
    public void createPdf(String dest) throws IOException {
        ...
        table.addCell(new Cell().add("Rotated").setRotationAngle(Math.PI / 18).setFont(font).setFontSize(8).setFontColor(ColorConstants.RED));
        table.addCell(new Cell().add("Centered").setTextAlignment(TextAlignment.CENTER).setAction(PdfAction.createGoTo("Top")));
        table.addCell(new Cell().add("Test 5").setBackgroundColor(ColorConstants.BLUE));
        ...
        table.addCell(new Cell().add("Test 7").setBackgroundColor(ColorConstants.RED));
        table.addCell(new Cell().add("Test 8").setBackgroundColor(ColorConstants.BLUE).setMarginBottom(10));
        table.addCell(new Cell().add("Test 9").setBackgroundColor(ColorConstants.BLUE));
        table.addCell(new Cell().add("Test 10").setBackgroundColor(ColorConstants.RED));
        ...
        table.addCell(new Cell().add("Test 12").setBackgroundColor(ColorConstants.BLUE));
        
        document.add(table);
        SolidBorder border = new SolidBorder(ColorConstants.RED, 2);
        Cell cell = new Cell().add("Test").setFixedPosition(100, 400, 350).setBorder(border).setBackgroundColor(ColorConstants.BLUE).setHeight(100).setHorizontalAlignment(HorizontalAlignment.CENTER);
        document.add(cell);
        document.close();
    }
}
